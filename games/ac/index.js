...
(() => {
	...
	loadPackage({
		files: [{
			filename: "/shaders/default.frag",
			start: 0,
			end: 14203
		}, {
			filename: "/shaders/default.vert",
			start: 14203,
			end: 15560
		}],
		remote_package_size: 15560
	})
})();
var arguments_ = [];
		...
		if (count > 0) {
			for (var i = 0; i < GL.currentContext.maxVertexAttribs; ++i) {
				...
				if (cb.clientside && cb.enabled) {
					...
					vertexes = new arrayClass(HEAPU8.buffer, indices, count)
...
var ASM_CONSTS = {
	3800249: $0 => {
		...
		var slot = path.indexOf("card_a") >= 0 ? "a" : path.indexOf("card_b") >= 0 ? "b" : null;
	...
	3809315: () => window.innerWidth,
	3809345: () => window.innerHeight
};

function __asyncjs__pc_web_mount_saves() {
	return Asyncify.handleAsync(async () => new Promise(function(resolve) {
		FS.mkdir("/save");
		FS.mount(IDBFS, {}, "/save");
...
function __asyncjs__pc_web_mount_rom() {
	return Asyncify.handleAsync(async () => new Promise(function(resolve) {
		try {
			FS.mkdir("/orig")
		} catch (e) {}
...
function __asyncjs__pc_web_prompt_for_rom() {
...
function __asyncjs__pc_yield_raf() {
	return Asyncify.handleAsync(async () => {
...
var _main, _malloc, _free, _pc_input_touch_button, _pc_input_touch_stick, _pc_input_touch_cstick, _setThrew, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_iii, dynCall_viii, dynCall_vi, dynCall_ii, dynCall_vii, dynCall_v, dynCall_viiiiii, dynCall_iiiiiiiii, dynCall_fi, dynCall_viiii, dynCall_iiiii, dynCall_i, dynCall_vifi, dynCall_iiii, dynCall_iff, dynCall_iffi, dynCall_iif, dynCall_iiiiiiii, dynCall_iiiiii, dynCall_viiiff, dynCall_viiiii, dynCall_viiiif, dynCall_iiiiiiiiii, dynCall_viiifii, dynCall_iiiiiii, dynCall_iiiiff, dynCall_viff, dynCall_viiifiii, dynCall_viiiiiii, dynCall_viiiiiiii, dynCall_viiiifff, dynCall_fiiiff, dynCall_iifff, dynCall_vif, dynCall_fii, dynCall_viiif, dynCall_viiff, dynCall_viiiiff, dynCall_iifffii, dynCall_iiiiifii, dynCall_iiiifii, dynCall_iiffii, dynCall_iiifi, dynCall_iifiiii, dynCall_iiiiiif, dynCall_iiiif, dynCall_viiffi, dynCall_vifffiiiiii, dynCall_vifffiiii, dynCall_viffffiii, dynCall_j, dynCall_viffff, dynCall_fiffffii, dynCall_ji, dynCall_jiji, dynCall_vffff, dynCall_vf, dynCall_viiiiiiiii, dynCall_vff, dynCall_vfi, dynCall_viif, dynCall_vifff, dynCall_vfff, dynCall_viiiiiiiiii, dynCall_viiiiiiiiiii, dynCall_viifi, dynCall_iiij, dynCall_viij, dynCall_iidiiii, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind, memory, __indirect_function_table, wasmMemory, wasmTable;

function assignWasmExports(wasmExports) {
	_main = Module["_main"] = wasmExports["hh"];
	_malloc = wasmExports["jh"];
	_free = wasmExports["kh"];
	_pc_input_touch_button = Module["_pc_input_touch_button"] = wasmExports["lh"];
	_pc_input_touch_stick = Module["_pc_input_touch_stick"] = wasmExports["mh"];
	_pc_input_touch_cstick = Module["_pc_input_touch_cstick"] = wasmExports["nh"];
	_setThrew = wasmExports["oh"];
	__emscripten_stack_restore = wasmExports["ph"];
	__emscripten_stack_alloc = wasmExports["qh"];
	_emscripten_stack_get_current = wasmExports["rh"];
	dynCall_iii = dynCalls["iii"] = wasmExports["sh"];
	dynCall_viii = dynCalls["viii"] = wasmExports["th"];
	dynCall_vi = dynCalls["vi"] = wasmExports["uh"];
	dynCall_ii = dynCalls["ii"] = wasmExports["vh"];
	dynCall_vii = dynCalls["vii"] = wasmExports["wh"];
	dynCall_v = dynCalls["v"] = wasmExports["xh"];
	dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["yh"];
	dynCall_iiiiiiiii = dynCalls["iiiiiiiii"] = wasmExports["zh"];
	dynCall_fi = dynCalls["fi"] = wasmExports["Ah"];
	dynCall_viiii = dynCalls["viiii"] = wasmExports["Bh"];
	dynCall_iiiii = dynCalls["iiiii"] = wasmExports["Ch"];
	dynCall_i = dynCalls["i"] = wasmExports["Dh"];
	dynCall_vifi = dynCalls["vifi"] = wasmExports["Eh"];
	dynCall_iiii = dynCalls["iiii"] = wasmExports["Fh"];
	dynCall_iff = dynCalls["iff"] = wasmExports["Gh"];
	dynCall_iffi = dynCalls["iffi"] = wasmExports["Hh"];
	dynCall_iif = dynCalls["iif"] = wasmExports["Ih"];
	dynCall_iiiiiiii = dynCalls["iiiiiiii"] = wasmExports["Jh"];
	dynCall_iiiiii = dynCalls["iiiiii"] = wasmExports["Kh"];
	dynCall_viiiff = dynCalls["viiiff"] = wasmExports["Lh"];
	dynCall_viiiii = dynCalls["viiiii"] = wasmExports["Mh"];
	dynCall_viiiif = dynCalls["viiiif"] = wasmExports["Nh"];
	dynCall_iiiiiiiiii = dynCalls["iiiiiiiiii"] = wasmExports["Oh"];
	dynCall_viiifii = dynCalls["viiifii"] = wasmExports["Ph"];
	dynCall_iiiiiii = dynCalls["iiiiiii"] = wasmExports["Qh"];
	dynCall_iiiiff = dynCalls["iiiiff"] = wasmExports["Rh"];
	dynCall_viff = dynCalls["viff"] = wasmExports["Sh"];
	dynCall_viiifiii = dynCalls["viiifiii"] = wasmExports["Th"];
	dynCall_viiiiiii = dynCalls["viiiiiii"] = wasmExports["Uh"];
	dynCall_viiiiiiii = dynCalls["viiiiiiii"] = wasmExports["Vh"];
	dynCall_viiiifff = dynCalls["viiiifff"] = wasmExports["Wh"];
	dynCall_fiiiff = dynCalls["fiiiff"] = wasmExports["Xh"];
	dynCall_iifff = dynCalls["iifff"] = wasmExports["Yh"];
	dynCall_vif = dynCalls["vif"] = wasmExports["Zh"];
	dynCall_fii = dynCalls["fii"] = wasmExports["_h"];
	dynCall_viiif = dynCalls["viiif"] = wasmExports["$h"];
	dynCall_viiff = dynCalls["viiff"] = wasmExports["ai"];
	dynCall_viiiiff = dynCalls["viiiiff"] = wasmExports["bi"];
	dynCall_iifffii = dynCalls["iifffii"] = wasmExports["ci"];
	dynCall_iiiiifii = dynCalls["iiiiifii"] = wasmExports["di"];
	dynCall_iiiifii = dynCalls["iiiifii"] = wasmExports["ei"];
	dynCall_iiffii = dynCalls["iiffii"] = wasmExports["fi"];
	dynCall_iiifi = dynCalls["iiifi"] = wasmExports["gi"];
	dynCall_iifiiii = dynCalls["iifiiii"] = wasmExports["hi"];
	dynCall_iiiiiif = dynCalls["iiiiiif"] = wasmExports["ii"];
	dynCall_iiiif = dynCalls["iiiif"] = wasmExports["ji"];
	dynCall_viiffi = dynCalls["viiffi"] = wasmExports["ki"];
	dynCall_vifffiiiiii = dynCalls["vifffiiiiii"] = wasmExports["li"];
	dynCall_vifffiiii = dynCalls["vifffiiii"] = wasmExports["mi"];
	dynCall_viffffiii = dynCalls["viffffiii"] = wasmExports["ni"];
	dynCall_j = dynCalls["j"] = wasmExports["oi"];
	dynCall_viffff = dynCalls["viffff"] = wasmExports["pi"];
	dynCall_fiffffii = dynCalls["fiffffii"] = wasmExports["qi"];
	dynCall_ji = dynCalls["ji"] = wasmExports["ri"];
	dynCall_jiji = dynCalls["jiji"] = wasmExports["si"];
	dynCall_vffff = dynCalls["vffff"] = wasmExports["ti"];
	dynCall_vf = dynCalls["vf"] = wasmExports["ui"];
	dynCall_viiiiiiiii = dynCalls["viiiiiiiii"] = wasmExports["vi"];
	dynCall_vff = dynCalls["vff"] = wasmExports["wi"];
	dynCall_vfi = dynCalls["vfi"] = wasmExports["xi"];
	dynCall_viif = dynCalls["viif"] = wasmExports["yi"];
	dynCall_vifff = dynCalls["vifff"] = wasmExports["zi"];
	dynCall_vfff = dynCalls["vfff"] = wasmExports["Ai"];
	dynCall_viiiiiiiiii = dynCalls["viiiiiiiiii"] = wasmExports["Bi"];
	dynCall_viiiiiiiiiii = dynCalls["viiiiiiiiiii"] = wasmExports["Ci"];
	dynCall_viifi = dynCalls["viifi"] = wasmExports["Di"];
	dynCall_iiij = dynCalls["iiij"] = wasmExports["Ei"];
	dynCall_viij = dynCalls["viij"] = wasmExports["Fi"];
	dynCall_iidiiii = dynCalls["iidiiii"] = wasmExports["Gi"];
	_asyncify_start_unwind = wasmExports["Hi"];
	_asyncify_stop_unwind = wasmExports["Ii"];
	_asyncify_start_rewind = wasmExports["Ji"];
	_asyncify_stop_rewind = wasmExports["Ki"];
	memory = wasmMemory = wasmExports["fh"];
	__indirect_function_table = wasmTable = wasmExports["ih"]
}
var wasmImports = {
	dh: __asyncjs__pc_web_mount_rom,
	eh: __asyncjs__pc_web_mount_saves,
	Pb: __asyncjs__pc_web_prompt_for_rom,
	y: __asyncjs__pc_yield_raf,
	ja: ___syscall_fcntl64,
	Ab: ___syscall_getcwd,
	qb: ___syscall_getdents64,
	Cb: ___syscall_ioctl,
	wb: ___syscall_mkdirat,
	ka: ___syscall_openat,
	nb: ___syscall_renameat,
	ob: ___syscall_rmdir,
	mb: ___syscall_stat64,
	pb: ___syscall_unlinkat,
	rb: __abort_js,
	...
	_g: _emscripten_exit_pointerlock,
	Jf: _emscripten_get_canvas_element_size,
	...
	ah: _emscripten_get_screen_size,
	Dg: _emscripten_glActiveTexture,
	Cg: _emscripten_glAttachShader,
	Bd: _emscripten_glBeginQuery,
	Tg: _emscripten_glBeginQueryEXT,
	cd: _emscripten_glBeginTransformFeedback,
	Bg: _emscripten_glBindAttribLocation,
	Ag: _emscripten_glBindBuffer,
	$c: _emscripten_glBindBufferBase,
	...
	xg: _emscripten_glBindTexture,
	Yb: _emscripten_glBindTransformFeedback,
	id: _emscripten_glBindVertexArray,
	Lg: _emscripten_glBindVertexArrayOES,
	...
	Rd: _emscripten_glClipControlEXT,
	kg: _emscripten_glColorMask,
	jg: _emscripten_glCompileShader,
	...
	Xb: _emscripten_glDeleteTransformFeedbacks,
	...
	Hg: _emscripten_glDrawBuffersWEBGL,
	Qf: _emscripten_glDrawElements,
	sc: _emscripten_glDrawElementsInstanced,
	Fg: _emscripten_glDrawElementsInstancedANGLE,
	...
	Wb: _emscripten_glGenTransformFeedbacks,
	fd: _emscripten_glGenVertexArrays,
	Jg: _emscripten_glGenVertexArraysOES,
	...
	Ng: _emscripten_glGetQueryObjecti64vEXT,
	Pg: _emscripten_glGetQueryObjectivEXT,
	Mg: _emscripten_glGetQueryObjectui64vEXT,
	yd: _emscripten_glGetQueryObjectuiv,
	Og: _emscripten_glGetQueryObjectuivEXT,
	zd: _emscripten_glGetQueryiv,
	Qg: _emscripten_glGetQueryivEXT,
	...
	ze: _emscripten_glTexParameteri,
	ye: _emscripten_glTexParameteriv,
	Mb: _emscripten_glTexStorage2D,
	Lb: _emscripten_glTexStorage3D,
	xe: _emscripten_glTexSubImage2D,
	Id: _emscripten_glTexSubImage3D,
	_c: _emscripten_glTransformFeedbackVaryings,
	we: _emscripten_glUniform1f,
	ve: _emscripten_glUniform1fv,
	ue: _emscripten_glUniform1i,
	te: _emscripten_glUniform1iv,
	Oc: _emscripten_glUniform1ui,
	Jc: _emscripten_glUniform1uiv,
	se: _emscripten_glUniform2f,
	...
	Zb: _emscripten_glVertexAttribDivisor,
	Eg: _emscripten_glVertexAttribDivisorANGLE,
	...
	Ud: _emscripten_glVertexAttribPointer,
	Td: _emscripten_glViewport,
	...
	ua: _emscripten_set_beforeunload_callback_on_thread,
	Ga: _emscripten_set_blur_callback_on_thread,
	w: _emscripten_set_canvas_element_size,
	O: _emscripten_set_element_css_size,
	Ha: _emscripten_set_focus_callback_on_thread,
	...
	Ka: _emscripten_set_mouseenter_callback_on_thread,
	Ja: _emscripten_set_mouseleave_callback_on_thread,
	Na: _emscripten_set_mousemove_callback_on_thread,
	La: _emscripten_set_mouseup_callback_on_thread,
	Ba: _emscripten_set_pointerlockchange_callback_on_thread,
	wa: _emscripten_set_resize_callback_on_thread,
	Ca: _emscripten_set_touchcancel_callback_on_thread,
	Ea: _emscripten_set_touchend_callback_on_thread,
	Da: _emscripten_set_touchmove_callback_on_thread,
	Fa: _emscripten_set_touchstart_callback_on_thread,
	va: _emscripten_set_visibilitychange_callback_on_thread,
	Ia: _emscripten_set_wheel_callback_on_thread,
	Zg: _emscripten_set_window_title,
	G: _emscripten_sleep,
	yb: _environ_get,
